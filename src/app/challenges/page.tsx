  ...
  const loadChallenges = async () => {
    const mockChallenges: Challenge[] = [
      ...
      },
      {
        ...
        instructions: 'Create a file, add it to staging, and commit it with a message containing the word initial.',
        orderIndex: 2,
        difficulty: 'beginner',
      ...
      },
      {
        ...
        instructions: 'Create a new feature branch and switch to it.',
        orderIndex: 3,
